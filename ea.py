...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; TECNO KG5p Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 OPR/69.0.2254.65737.{str(random.randint(100000, 900000))};]"
	...
	ua = f"Dalvik/2.1.0 (Linux; U; Android 10; Infinix X688B Build/QP1A) [FBAN/MessengerLite;FBAV/{versi_chrome};FBBV/54364624;FBDM/"+"{density=2.0,width=720,height=1360};"+f"FBLC/en_US;FBRV/156625696;FBCR/T-Mobile;FBID/phone;FBMF/iPhone;FBBD/iPhone;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/346850586;FBCR/TNT;FBMF/INFINIX MOBILITYLIMITED;FBBD/Infinix;FBDV/InfinixX688B;FBSV/10;FBCA/arm64-v8a:null;FBDM/"+"{density=2.0,width=720,height=1472};]"
...
{color_text}│ {P2}Author : XyzonXD     {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}Dont't Recode My Tools Bro {color_text}│
